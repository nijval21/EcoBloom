...
const Update_Contact_Number = ({ visible, onClose }) => {
  ...
  return (
    ...
    >
      <div className="bg-[#E1E1E0] p-7 rounded-lg w-[60%] h-[20rem] lg:w-[40rem] flex flex-col items-center  mt-7 gap-3 lg:h-[30rem]">
        <div className=" text-center text-lg text-[#277868]">
          Terms & Conditions
        </div>
